        ...
        <>
            <header className="text-sm flex space-b w-full justify-between">
                ...
                <nav className="flex gap-2 justify-between items-center">
                    ...
                    <img src="/assets/Expand.svg" alt="Expand" onClick={() => setExpanded(!expanded)}/>
                </nav>
            </header>
                    ...
                    <ul className="*:flex *:gap-4 *:py-2">
                        ...
                        <div className="ml-9" style={{ padding: 0, }}>
                            <ol className={`${!switchLanguage ? 'hidden' : 'block'} *:py-2`}>
                                <li onClick={() => handleSwitch('zh')}>简体中文</li>
                                <li onClick={() => handleSwitch('en')}>English</li>
                            </ol>
                        </div>
                        <li><img className="w-5 h-5 aspect-square" src="/assets/Exit.svg" alt="Exit"/> 断开连接</li>
                    </ul>
                </div>
            </div>
        </>
